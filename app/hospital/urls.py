...
urlpatterns = [
    ...
    path("accept-hospital/<str:id>/",AcceptHospitalView.as_view(),name="accept-hospital"),
    path("decline-hospital/<str:id>/",DeclineHospitalView.as_view(),name="decline-hospital"),
